...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Phùng Gia Long ( Logn )
❎ Tuổi: 14 🐒
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m74 x 57kg
💘 Mối quan hệ: Hẹn Hò
🌎 Quê quán: Ninh Bình ( Ninh An - 35 )
👫 Gu: Biết nấu cơm
...
✉️ Email: Longdeeptry287@gmail.com`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${666081179}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
